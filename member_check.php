...
<tr>
   ...
   <?php
   $today = date("Y/m/d");
   $query3 = "select * from member,orderlist,menu where member.member_id = '$id' and member.member_id=orderlist.member_id 
    and orderlist.menu_name=menu.menu_name and orderlist.order_date='$today'";
