<?php
    ...
    $query3 = "select menu_no, menu_name, menu_price, img_path from ( select m.menu_no, m.menu_name, m.menu_price, m.img_path, rownum n from menu m where menu_name <> ' ' ) where n >= 4 and n <= 6";
?>
